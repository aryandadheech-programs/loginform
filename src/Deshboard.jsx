...
export default function Deshboard({
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'https://mernauth-backend-29ek.onrender.com/api/auth/users',
        {
          method: 'GET',
  ...
  const handleDeleteUser = async (id) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://mernauth-backend-29ek.onrender.com/api/auth/users/${id}`,
        {
          method: 'DELETE',
    ...
    <div className="min-h-screen bg-slate-900 text-white p-4 md:p-8">
      ...
      <div className="max-w-5xl mx-auto bg-slate-800 p-6 rounded-2xl border border-slate-700 shadow-xl flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="bg-rose-600 hover:bg-rose-500 text-white font-semibold py-2.5 px-6 rounded-xl"
        >
            ...
            <div className="overflow-x-auto">
              ...
              <table className="w-full text-left">
                ...
                <thead>
                  ...
                  <tr className="bg-slate-900/50 border-b border-slate-700 text-slate-300 text-sm">
                      ...
                      <td className="p-4 text-center">
                        ...
                        {u.email !== user?.email ? (
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 bg-rose-600/10 hover:bg-rose-600 border border-rose-500/20 hover:border-rose-500 text-rose-400 hover:text-white text-xs font-semibold py-1.5 px-3 rounded-lg"
                          >
                          ...
                          <span className="text-xs text-slate-500 italic font-medium bg-slate-900 px-2 py-1 rounded">
